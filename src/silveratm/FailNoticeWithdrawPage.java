...
/**
 * @description 11p. 잔액이 부족한 경우 인출 실패 화면.
 * @author SWE_Team2
 *
 */
////화면 구성 끝
public class FailNoticeWithdrawPage extends ATMPanel{
	private static final long serialVersionUID = 903855777236187839L;
	...
	public void create(ATM parent) {
		...
		// 잔액이 부족합니다. 잔액 확인 후 다시 시도해주세요.
		label1 = new JLabel("<html>잔액이 부족합니다.<br/><br/>잔액 확인 후<br/>다시 시도해주세요.");
		label1.setFont(font);
		label1.setBounds(50, 50, ATM.PageWidth - 100, 400);
