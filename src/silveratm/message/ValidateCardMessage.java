 ...
 * 카드 인증 메시지
 */
public abstract class ValidateCardMessage {

	public static final String TYPE = "ValidateCard:"; 
	...
	public static class Request implements Message {
		...
		public String getMessageString() {
			...
			msg.append("securityCode=").append(securityCode);
		...
		public boolean setMessageString(String msg) {
			...
			for (String param : params) {
				...
				name = nameValue.length > 0 ? nameValue[0] : null;
				value = nameValue.length > 1 ? nameValue[1] : null;
